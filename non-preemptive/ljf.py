...
class LJF:
    def processData(self, no_of_processes):
        ...
        LJF.schedulingProcess(self, process_data)
    ...
    def schedulingProcess(self, process_data):
        ...
        t_time = LJF.calculateTurnaroundTime(self, process_data)
        w_time = LJF.calculateWaitingTime(self, process_data)
        LJF.printData(self, process_data, t_time, w_time)
...
if __name__ == "__main__":
    ...
    ljf = LJF()
    ljf.processData(no_of_processes)
